package com.fehu.heimdall.adapters;

public class RecyclerViewAdapter { //extends RecyclerView.Adapter<FehuIndexViewHolder> {
    ...
    public RecyclerViewAdapter(Context context, ProductsList productsList, boolean asFavoriteList) {
