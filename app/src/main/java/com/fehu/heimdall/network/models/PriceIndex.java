...
public class PriceIndex {
    ...
    PriceIndex(@NonNull String timestamp, String usdBTC, String usdSAT, String sekBTC, String sekSAT) {
    ...
    public static class Builder {
        ...
        public PriceIndex Build() {
            return new PriceIndex(timestamp, usdBTC, usdSAT, sekBTC, sekSAT);
        }
